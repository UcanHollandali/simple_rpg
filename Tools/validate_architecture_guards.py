...
HOTSPOT_FILE_LINE_LIMITS = {
    ...
    PROJECT_ROOT / "scenes" / "combat.gd": 1826,
    PROJECT_ROOT / "scenes" / "map_explore.gd": 1936,
    PROJECT_ROOT / "Game" / "UI" / "map_board_composer_v2.gd": 1258,
    PROJECT_ROOT / "Game" / "Infrastructure" / "save_service.gd": 1068,
    PROJECT_ROOT / "Game" / "Application" / "inventory_actions.gd": 1073,
    PROJECT_ROOT / "Game" / "Application" / "run_session_coordinator.gd": 1017,
    PROJECT_ROOT / "Game" / "RuntimeState" / "inventory_state.gd": 1039,
