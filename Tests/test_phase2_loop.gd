	...
	match _phase:
		...
		3:
			if _is_scene("Combat"):
				...
				_require_inventory_card_action_copy("Margin/VBox/SecondaryScroll/SecondaryScrollContent/QuickItemSection/EquipmentCard/EquipmentCardsFlow/InventorySlotRIGHTHANDCard", "Packed spare needed")
...
func _require_combat_readability_shell() -> void:
	...
	_require(defense_preview_label != null and defense_preview_label.visible and defense_preview_label.text.contains("Gain") and defense_preview_label.text.contains("hunger"), "Expected defend action card to explain the guard result and hunger tradeoff directly.")
