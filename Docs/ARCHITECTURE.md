...
- `Tools/validate_architecture_guards.py` is the current narrow automation floor for catching silent boundary drift.
- Its semantic hard-fail guards cover owner/truth/coupling regressions, compatibility creep, facade/public-surface widening, live contract drift, and catalog or legacy-surface regressions.
- Its hotspot-growth and workflow-doc-ballast checks are ergonomic warnings. They protect repo maintainability and continuation clarity; they are not gameplay authority.
