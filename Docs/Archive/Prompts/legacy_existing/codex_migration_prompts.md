...
> **Cross-track önkoşul notu:** Bu migration serisi tek başına düşünülmemeli.
> - `codex_refactor_plan.md` Part 5 içindeki GO / NO-GO readiness gate geçmeden Part 2+ başlatma.
> - Eğer `codex_map_redesign_prompts.md` track'i kullanılacaksa, onun Part 4-8'ini Migration Part 6'dan önce bitir.
> - Eğer `codex_ui_rework_prompts.md` track'i kullanılacaksa, onun Part 2-7'sini Migration Part 10'dan önce bitir.
> - Migration Part 10 artık tam UI redesign değil; mevcut UI foundation'a yeni migration verisini plug etme/polish pass'i olarak düşün.
...
Eger `codex_map_redesign_prompts.md` Part 1-8 zaten tamamlandıysa:
- mevcut topology/composer/layout ve roadside bug fix sonucunu settled kabul et
- bu part'ta runtime graph/composer redesign'ı yeniden açma
- Event / Roadside / Hamlet / Side Quest taxonomy ve routing'i o stabil map temelinin üstüne kur
...
Bu pass tam UI redesign DEĞİL.
Eger `codex_ui_rework_prompts.md` Part 2-7 zaten tamamlandıysa, o shared foundation ve shell'leri authoritative kabul et.
Bu part'in işi:
- yeni migration-era data'yı (equipment slots, Guard, perk, shield/offhand durumları) mevcut UI foundation'a plug etmek
- yeni terminolojiyi yerleştirmek
- migration sonrası stale label/helper text temizlemek
...
- UI Rework Part 6'da kurulmuş reward vs level-up ekran ayrımını migration-era copy/state ile güncelle
...
- UI Rework'ün kurduğu shared shell/layout sistemini baştan yazma
- Final audit pass
...
- Part 10 ve Part 11 paralel gidebilir; ancak UI rework track aktifse önce onun Part 7'si bitmiş olmalı.
